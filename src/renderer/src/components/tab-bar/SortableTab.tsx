      ...
      >
        ...
        >
          ...
          {showActivityAffordance ? (
            ...
            // uses a bold-title treatment (see docs/bold-instead-of-bell.md).
            // The tab bar keeps the bell for now — aligning the two surfaces
            // is a deliberate follow-up (out-of-scope in that doc).
