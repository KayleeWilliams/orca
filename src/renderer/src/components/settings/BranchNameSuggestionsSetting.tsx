      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 shrink space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            that agent for a cleaner branch name and show it before applying. Skips tracked or
            pushed branches, and does not apply retroactively to existing worktrees.
          </p>
        ...
        <SettingsSwitch
          checked={settings.experimentalBranchNameSuggestions}
          ariaLabel="Branch name suggestions"
          onChange={() => {
            updateSettings({
